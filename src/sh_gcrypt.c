 ...
 **************************************************************************/
//
//bool encrypt_file_old(char *in_file_name, char *out_file_name) {
//	FILE *in_file = NULL;
//	FILE *out_file = NULL;
//
//	gcry_cipher_hd_t cipher_handle = NULL;
...
//
//	if (!init_hmac(&hmac_handle, hmac_key)) {
//		print_error_str("encrypt_file() Unable init hmac\n");
//		result = false;
//		goto CLEANUP;
//	}
//
...
//		fwrite(buffer, 1, write_bytes, out_file);
//
//		error = gcry_mac_write(hmac_handle, buffer, write_bytes);
//		if (error) {
//			print_error("encrypt_file() Calling gcry_mac_write failed: %s/%s\n", gcry_strsource(error), gcry_strerror(error));
//			result = false;
//			goto CLEANUP;
//		}
//	}
...
//	//todo
//
//	///size_t hmac_len = gcry_mac_get_algo_maclen(GCRY_MAC_HMAC_SHA512);
//	//print_debug("hmac_len: %zu\n", hmac_len);
//	//unsigned char *hmac = malloc(hmac_len);
//
//	size_t hmac_len = HMAC_LEN;
//	unsigned char hmac[HMAC_LEN];
//
...
//	error = gcry_mac_read(hmac_handle, hmac, &hmac_len);
//	if (error) {
//		print_error("encrypt_file() Calling gcry_mac_read failed: %s/%s\n", gcry_strsource(error), gcry_strerror(error));
//		result = false;
//		goto CLEANUP;
//	}
//
...
//
//	// todo: error handling
//	fseek(out_file, CIPHER_BLOCK_LEN + HMAC_LEN, SEEK_SET);
//	unsigned char hmac_read[HMAC_LEN];
//	get_hmac_from_file(out_file, hmac_read);
//	print_block("hmac_read", hmac_read, HMAC_LEN, 16);
//
//	//
//	// Cleanup allocated resources
//	//
 ...
 **************************************************************************/
//
//bool decrypt_file_old(char *in_file_name, char *out_file_name) {
//	FILE *in_file = NULL;
//	FILE *out_file = NULL;
//
//	gcry_cipher_hd_t cipher_handle = NULL;
...
//	}
//
//	unsigned char hmac_from_file[HMAC_LEN];
//
//	if (!read_array_from(in_file, hmac_from_file, HMAC_LEN, 0, SEEK_SET)) {
//		print_error("decrypt_file() Unable to read hmac from file: %s\n", in_file_name);
//		result = false;
//		goto CLEANUP;
//	}
//
...
//
//	if (!init_hmac(&hmac_handle, hmac_key)) {
//		print_error_str("decrypt_file() Unable init hmac\n");
//		result = false;
//		goto CLEANUP;
//	}
//
...
//		goto CLEANUP;
//	}
//	print_block("hmac", hmac, HMAC_LEN, 16);
//
//	CLEANUP:
//
//	cleanup_cipher_handle(&cipher_handle);
...
//
//	encrypt_file("/home/senkel/Desktop/workspaces/workspace_c/sec_handover/resources/sec_handover.cfg", "/home/senkel/Desktop/workspaces/workspace_c/sec_handover/resources/sec_handover.cfg.test.enc");
//	decrypt_file("/home/senkel/Desktop/workspaces/workspace_c/sec_handover/resources/sec_handover.cfg.test.enc", "/home/senkel/Desktop/workspaces/workspace_c/sec_handover/resources/sec_handover.cfg.test");
//
//	if (!compare_files("/home/senkel/Desktop/workspaces/workspace_c/sec_handover/resources/sec_handover.cfg", "/home/senkel/Desktop/workspaces/workspace_c/sec_handover/resources/sec_handover.cfg.test")) {
